function [x,ebuf,Zi] = celp_synthesis(cb,kappa,k,theta0,P,b,ebuf,Zi)
%CELP_SYNTHESIS CELP synthesizer (decoder).
%
...
a = celp_rf2lpc(kappa);                      % Convert kappa to a parameters.
