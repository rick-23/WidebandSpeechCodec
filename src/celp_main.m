function [xhat,e,k,theta0,P,b] = celp_main(x,N,L,M,c,cb,Pidx)

%  celp --> 16000 bps CELP analysis and synthesis codec.
%
...
for f=1:F
  ...
  [kappa,kf,theta0f,Pf,bf,ebuf,Zf,Zw] = celp_analysis(x(n),L,M,c,cb,Pidx,bbuf,...
                                                                ebuf,Zf,Zw);
  ...
  [xhat(n),ebuf2,Zi] = celp_synthesis(cb,kappa,kf,theta0f,Pf,bf,ebuf2,Zi);
